            ...
            <footer id="footer">
                ...
                <section>
                    ...
                    <p>This portfolio is made for an exhibition in the course <em>IDG3800 - Portfolio and Exhibition</em>. In the start of the course I made a plan on how 
                        I should make my portfolio, and my roles in the course. I was a part of the party-comitee, where we arranged a quiz and a preparty before an event in UKA in Gjøvik.
                    ...
                    <p>For the portfolio, I didnt quite stick to my plan. I had a plan to use Gatsby, and a template to quicly set up a page and design.
                        ...
                        and to show ofdf my skills as a web developer. I ended up using React, where I have made everything from scratch. I already knew React, and I love to work with CSS,
                        and even though I am not a designer I am satisfied with how it turned out. I had set up a timeline, and had a goal to pick a technology to work with by March 18th,
