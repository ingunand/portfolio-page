...
class Bachelor extends React.Component {
    ...
    render() {
      return (
        ...
        <section>
            <h4>Background</h4>
            <p>The bachelorproject was a group project of 22.5 study points  where we worked a semester to make an app and a report to show what we have learned over 
                ...
                We got the project from Gjøvik kommune, which wanted a local solution for food waste. The result of this whole process is the mobile app Hamle.
                Hamle is an app made in React, with back-end and login from Firebase, deployed to Netlify. 
        ...
        <section>
            ...
            <p>The first imporovements I would want to make is to make the inventory list and shopping list more distinct from each other. 
                The inventory does not need a checkbox. It would also be good to have an overview over how long you have had the food in your 
                fridge, and how many of it you have. That is really the most important thing I would add to make the app more usable. 
                There are of course some other improvements that could be wished to add, but that is not as important. 
            </p>
        </section>
